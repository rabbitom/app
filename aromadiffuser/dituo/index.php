<?php
	$title = 'Aroma Therapy Life';
	$android_url = 'aromatherapylife.apk';
	$ios_url = 'https://itunes.apple.com/us/app/aroma-therapy-life/id1183694617?l=zh&ls=1&mt=8';
?>
<html>
<head>
	<meta charset="utf-8">
	...
	<style type="text/css">
		body{background: url("../images/app_logo_default.png") #FFF no-repeat center;}
		.button{
...
<?php
	...
	if(stristr($_SERVER['HTTP_USER_AGENT'],'Android')) {
		echo '<a href="'.$android_url.'" class="green button atbottom">Download<span>apk file</span></a>';
		...
		<br/>
		for Android users, please download the apk file and install it:&nbsp;<br/><img src="../images/android_logo.png"/><a href="'.$android_url.'" class="green button">Download<span>apk file for Android</span></a>
		';
	}
?>
	<div id="mask"></div>
